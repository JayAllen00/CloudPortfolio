...
PORT = 1234
LISTENER_LIMIT = 5
active_clients = [] # List of all active connected users
...
# Function to send any new message to all the clients that are activley connected to the server
...
def client_handler(client):
    ...
    while 1:
        ...
        if username != '':
            ...
            prompt_message = "CHATSERVER~" + f"{username} added to the chat"
